package dc.pay.utils.ipUtil.qqwry.qqwry3.ipparse;
...
import dc.pay.utils.ipUtil.qqwry.entry.Message;
...
public class IPSeeker {
    ...
    private static final String tmpdir = System.getProperty("java.io.tmpdir").concat(separator).concat("qqwry.dat");
    ...
    public IPSeeker(String file)  {
        ...
        try {
            ...
            try {
                ipFile = new RandomAccessFile(tmpdir, "r");
            } catch (FileNotFoundException e1) {
                //释放文件
                try {
                    FileUtils.copyToFile(IPSeeker.class.getResourceAsStream(file),new File(tmpdir));
                    ipFile = new RandomAccessFile(tmpdir, "r");
