package dc.pay.business.chengyizhifu;
...
public final class ChengYiZhiFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(ChengYiZhiFuPayRequestHandler.class);
    ...
    protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String pay_md5sign) throws PayException {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("[诚意支付]3.3. 发送支付请求，公钥加密支付请求结果出错：", e);
