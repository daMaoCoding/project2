...
@Slf4j
@ResponseDaifuHandler("YUNBAODAIFU")
public final class YunBaoDaiFuResponseHandler extends DaifuResponseHandler {
    ...
    public String processForOrderId(Map<String, String> API_RESPONSE_PARAMS) throws PayException {
        ...
        String bizContent="";
        try {
            bizContent = YunBaoPayUtils.decrypt(API_RESPONSE_PARAMS.get("cipher"),apiKeyFromMemberId);
        } catch (Exception e) {
        ...
        log.debug("1.[云宝代付]-[代付回调]-获取回调订单号：{}",ordernumberR);
        return ordernumberR;
    }
    ...
    protected String buildPaySign(Map<String, String> payParam, String api_key) throws PayException {
        ...
        try {
            if (signRes != null && YunBaoPayUtils.verify(payParam, signRes, channelWrapper.getAPI_PUBLIC_KEY())) {
                return TRUE;
            }
            return FALSE;
        } catch (Exception e) {
    ...
    protected boolean checkSignMd5(Map<String, String> api_response_params, String signMd5) {
        ...
        log.debug("4.[云宝代付]-[代付回调]-验证第三方签名：{}",result);
        return result;
    }
   ...
   @Override
    protected boolean checkAmount(Map<String, String> api_response_params, String amountDb) throws PayException {
        String bizContent="";
        try {
            bizContent = YunBaoPayUtils.decrypt(api_response_params.get(cipher),channelWrapper.getAPI_KEY());
        } catch (Exception e) {
            throw new PayException("解密回调数据获取订单号错误，请检查私钥。");
        }
        ...
        log.debug("3.[云宝代付]-[代付回调]-验证回调金额：{}",checkResult);
        return checkResult;
    }
    ...
    protected PayEumeration.DAIFU_RESULT  resOrderStatus(Map<String, String> api_response_params) throws PayException {
        ...
        log.debug("6.[云宝代付]-[代付回调]-订单状态：{}",orderStatus);
        return orderStatus;
    }
    ...
    protected String responseSuccess() {
        log.debug("5.[云宝代付]-[代付回调]-响应第三方内容：{}",RESPONSE_PAY_MSG);
