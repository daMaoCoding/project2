...
@Slf4j
@RequestPayHandler("XINFUTONGZHIFU")
public final class XinFuTongZhiFuPayRequestHandler extends PayRequestHandler {
    ...
    protected Map<String, String> buildPayParam() throws PayException {
        ...
        log.debug("[鑫付通支付]-[请求支付]-1.组装请求参数完成：" + JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected String buildPaySign(Map<String,String> params) throws PayException {
        //key的拼接顺序：如用到了所有参数，就按这个顺序拼接：notify_url + order_id + order_name + price + return_url + token + type + uid
...
*/				
             ...
             log.error("[鑫付通支付]3.发送支付请求，及获取支付请求结果出错：", e);
             throw new PayException(e.getMessage(), e);
        }
        log.debug("[鑫付通支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}" ,JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[鑫付通支付]-[请求支付]-4.处理请求响应成功：" + JSON.toJSONString(requestPayResult));
