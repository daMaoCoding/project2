package dc.pay.business.spayzhifu;
...
@Slf4j
@RequestPayHandler("SPAYZHIFU")
public final class SpayZhiFuPayRequestHandler extends PayRequestHandler {
...
//            payParam.put(pay_bankcode,"QRCODE");
        ...
        log.debug("[Spay支付]-[请求支付]-1.组装请求参数完成：" + JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected String buildPaySign(Map<String,String> params) throws PayException {
        //pay_memberid^YM0001&pay_orderid^40288184626d555601626d5556f60001&pay_amount^100&pay_applydate^20180328235421&pay_channelCode^BANK&pay_notifyurl^http://localhost/notice&key=345677565t765sasa
//        String paramsStr = String.format("pay_memberid^%s&pay_orderid^%s&pay_amount^%s&pay_applydate^%s&pay_channelCode^%s&pay_bankcode^%s&pay_notifyurl^%s&key=%s",
...
//                params.get(pay_notifyurl),
        ...
        log.debug("[Spay支付]-[请求支付]-2.生成加密URL签名完成：" + JSON.toJSONString(signMd5));
        return signMd5;
    }
...
//      }
        ...
        log.debug("[Spay支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}" ,JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[Spay支付]-[请求支付]-4.处理请求响应成功：" + JSON.toJSONString(requestPayResult));
