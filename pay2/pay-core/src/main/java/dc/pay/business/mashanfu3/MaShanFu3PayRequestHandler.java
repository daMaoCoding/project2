package dc.pay.business.mashanfu3;
...
@RequestPayHandler("MASHANFU3")
public final class MaShanFu3PayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(MaShanFu3PayRequestHandler.class);
