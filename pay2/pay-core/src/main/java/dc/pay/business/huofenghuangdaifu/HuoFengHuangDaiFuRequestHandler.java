...
//          当status=success和refCode=1同时成立时才表示转账成功
            ...
            if (HandlerUtil.valJsonObj(jsonObj, "status", "success") && HandlerUtil.valJsonObj(jsonObj, "refCode", "7"))
                return PayEumeration.DAIFU_RESULT.ERROR;
            if (HandlerUtil.valJsonObj(jsonObj, "refCode", "3", "4", "6")) return PayEumeration.DAIFU_RESULT.PAYING;
            if (HandlerUtil.valJsonObj(jsonObj, "refCode", "2", "5", "8")) return PayEumeration.DAIFU_RESULT.ERROR;
