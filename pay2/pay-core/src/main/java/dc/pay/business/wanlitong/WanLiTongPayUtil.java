 ...
 */
public class WanLiTongPayUtil {
    private static final Logger log = LoggerFactory.getLogger(WanLiTongPayUtil.class);
    ...
    public static String generatePayRequest(Map<String, String> paramsMap, String api_key) throws PayException {
        try {
            ...
            log.error("[万里通_HelibaoPayUtil]将由支付请求参数构成的map转换成支付串，并对参数做合法验证出错。" + ex.getMessage(), ex);
