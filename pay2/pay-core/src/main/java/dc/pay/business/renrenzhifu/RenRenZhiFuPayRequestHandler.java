...
@Slf4j
@RequestPayHandler("RENRENZHIFU")
public final class RenRenZhiFuPayRequestHandler extends PayRequestHandler {
    ...
    private static final String  way = "way";  //  整数  交易方式  1、微信扫码  2、  支付宝扫码  3、微信 WAP 4支付宝WAP
    ...
    private static final String  sign = "sign";  //   字符串  签名，详见支付请求的签名  方式
    ...
    protected Map<String, String> buildPayParam() throws PayException {
        ...
        if(1==1){  //HandlerUtil.isWY(channelWrapper)
            ...
            payParam.put(remark, channelWrapper.getAPI_KEY());
        }
        log.debug("[人人支付]-[请求支付]-1.组装请求参数完成：" + JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected String buildPaySign(Map<String,String> params) throws PayException {
        //string sign=md5(mid+oid+amt+way+back+notify+md5key)
...
*/				
             ...
             log.error("[人人支付]3.发送支付请求，及获取支付请求结果出错：", e);
             throw new PayException(e.getMessage(), e);
        }
        log.debug("[人人支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}" ,JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[人人支付]-[请求支付]-4.处理请求响应成功：" + JSON.toJSONString(requestPayResult));
