...
@Slf4j
@ResponseDaifuHandler("HENGRUNTONGDAIFU")
public final class HengRunTongDaiFuResponseHandler extends DaifuResponseHandler {
...
//        log.debug("1.[恒润通代付]-[代付回调]-获取回调订单号：{}",ordernumberR);
//        return ordernumberR;
        throw new PayException("[恒润通代付]-[代付回调]-该第三方无自动回调需手动查询，所以本类无用。以后如果第三方增加自动回调，再请编写。");
    }
    ...
    protected String buildPaySign(Map<String, String> payParam, String api_key) throws PayException {
        ...
        log.debug("2.[恒润通代付]-[代付回调]-自建签名：{}",pay_md5sign);
        return pay_md5sign;
    }
    ...
    protected boolean checkAmount(Map<String, String> api_response_params, String amountDb) throws PayException {
        ...
        log.debug("3.[恒润通代付]-[代付回调]-验证回调金额：{}",checkResult);
        return checkResult;
    }
    ...
    protected boolean checkSignMd5(Map<String, String> api_response_params, String signMd5) {
        ...
        log.debug("4.[恒润通代付]-[代付回调]-验证第三方签名：{}",result);
        return result;
    }
    ...
    protected String responseSuccess() {
        log.debug("5.[恒润通代付]-[代付回调]-响应第三方内容：{}",RESPONSE_PAY_MSG);
    ...
    protected PayEumeration.DAIFU_RESULT  resOrderStatus(Map<String, String> api_response_params) throws PayException {
        ...
        log.debug("6.[恒润通代付]-[代付回调]-订单状态：{}",orderStatus);
        return orderStatus;
    }
