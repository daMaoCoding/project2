package dc.pay.business.yaopan;
 ...
 * Mar 17, 2018
 */
@RequestPayHandler("YAOPAN")
public final class YaoPanPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(YaoPanPayRequestHandler.class);
...
*/
        ...
        log.debug("[瑶槃]-[请求支付]-1.组装请求参数完成：" + JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected String buildPaySign(Map<String,String> api_response_params) throws PayException {
		...
		log.debug("[瑶槃]-[请求支付]-2.生成加密URL签名完成：" + JSON.toJSONString(desEncrypt));
        return desEncrypt;
    }
    ...
    protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String pay_md5sign) throws PayException {
    	...
    	try {
            ...
            if (StringUtils.isBlank(tmpStr)) {
            	log.error("[瑶槃]3.1.发送支付请求，获取支付请求返回值异常:返回空");
            ...
            if (null == jsonObject || (jsonObject.containsKey("result")  && !"200".equals(jsonObject.getString("result")))) {
            	log.error("[瑶槃]3.2.发送支付请求，获取支付请求返回值异常:"+jsonObject.toString());
...
//            }
    		...
    		log.error("[瑶槃]3.3.发送支付请求，及获取支付请求出错，订单号：" + channelWrapper.getAPI_ORDER_ID() + ",通道名称：" + api_channel_bank_name + ",postUrl:" + api_CHANNEL_BANK_URL + ",payForManagerCGIResultJsonObj" + e.getMessage(), e);
			throw new PayException(null != e.getMessage() ? e.getMessage() : "请求第三方，返回Null",e);
    	}
        log.debug("[瑶槃]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：" + JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[瑶槃]-[请求支付]-4.处理请求响应成功：" + JSON.toJSONString(requestPayResult));
