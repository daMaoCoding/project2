...
public class XinFuBaoPayUtil {
    ...
    public static String createSign(Map<String, String> packageParams, String partnerKey) {
        ...
        while (it.hasNext()) {
            ...
            if (StringUtils.isNotEmpty(v) && !"signData".equalsIgnoreCase(k) &&!"sign".equals(k) && !"key".equals(k) && StringUtils.isNotBlank(v)) {
                sb.append(k + "=" + v + "&");
            }
        }
    ...
    public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = sign(prestr, "商户秘钥", "UTF-8");
        return mysign;
    }
