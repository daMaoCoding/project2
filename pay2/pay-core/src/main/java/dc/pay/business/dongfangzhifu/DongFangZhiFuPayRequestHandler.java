 ...
 * Mar 28, 2019
 */
@RequestPayHandler("DONGFANGZHIFU")
public final class DongFangZhiFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(DongFangZhiFuPayRequestHandler.class);
    ...
    private static final String pay_bankcode                ="pay_bankcode";   //    银行编码  是    是    在商户中心查询
...
//    private static final String pay_type                    ="pay_type";       //    返回数据格式:json    否    是    固定值：json ，部分通道不支持json返回，支持对通道会返回json格式数据
//    private static final String pay_md5sign                 ="pay_md5sign";    //    MD5签名    是    是    请查看签名算法
...
//                put(pay_type,"json");
        ...
        log.debug("[东方支付]-[请求支付]-1.组装请求参数完成：{}" ,JSON.toJSONString(payParam));
        return payParam;
    }
     ...
     protected String buildPaySign(Map<String,String> api_response_params) throws PayException {
        ...
        log.debug("[东方支付]-[请求支付]-2.生成加密URL签名完成：{}" ,JSON.toJSONString(signMd5));
        return signMd5;
    }
    ...
    protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String pay_md5sign) throws PayException {
        ...
        try {
            ...
            log.error("[东方支付]-[请求支付]-3.3.发送支付请求，及获取支付请求结果出错：", e);
            throw new PayException(null != e.getMessage() ? e.getMessage() : "请求第三方，返回Null",e);
        }
        ArrayList<Map<String, String>> payResultList = Lists.newArrayList();
        payResultList.add(result);
        log.debug("[东方支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}",JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[东方支付]-[请求支付]-4.处理请求响应成功：{}",JSON.toJSONString(requestPayResult));
