 ...
 * Jun 24, 2019
 */
@RequestPayHandler("HAIFU")
public final class HaiFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(TongSaoRequestHandler.class);

    //请求参数名   参数值 是否为空    加入签名    说明
    //版本号 version N   Y   版本号默认1.0
    private static final String version                ="version";
    //商户ID    customerid  N   Y   商户ID
    private static final String customerid                ="customerid";
    //订单编号    sdorderno   N   Y   随机生成
    private static final String sdorderno                ="sdorderno";
    //支付金额    total_fee   N   Y   单位：元 ，必须为两位小数点
    private static final String total_fee                ="total_fee";
    //回调地址    notifyurl   N   Y   支付完成后通知地址
    private static final String notifyurl                ="notifyurl";
    //通知地址    returnurl   N   Y   支付完成后跳转地址
    private static final String returnurl                ="returnurl";
    //支付类型    paytype N   N   支付类型，主流支付方式，参考附录
    private static final String paytype                ="paytype";
    //备注信息    remark  Y   N   订单备注信息
//    private static final String remark                ="remark";
    //网银支付类型  bankcode    Y   N   详见最底下编码
//    private static final String bankcode                ="bankcode";
    //签名  sign    N   N   32位小写MD5签名值
...
//            log.error("[海付]-[请求支付]-“支付通道商号”输入数据格式为【中间使用&分隔】：商户号&机构号" );
//            throw new PayException("[海付]-[请求支付]-“支付通道商号”输入数据格式为【中间使用&分隔】：商户号&机构号" );
//        }
        ...
        log.debug("[海付]-[请求支付]-1.组装请求参数完成：{}" ,JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected String buildPaySign(Map<String,String> api_response_params) throws PayException {
        ...
        log.debug("[海付]-[请求支付]-2.生成加密URL签名完成：{}" ,JSON.toJSONString(signMd5));
        return signMd5;
    }
...
//            //    log.error("[海付]-[请求支付]-3.1.发送支付请求，及获取支付请求结果：" + JSON.toJSONString(resultStr) + "订单号：" + channelWrapper.getAPI_ORDER_ID() + " ,通道：" + channelWrapper.getAPI_CHANNEL_BANK_NAME_FlAG());
//            //    throw new PayException(resultStr);
//            //    //log.error("[海付]-[请求支付]-3.1.发送支付请求，获取支付请求返回值异常:返回空,参数：{}",JSON.toJSONString(map));
...
//        }
        ...
        log.debug("[海付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}",JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[海付]-[请求支付]-4.处理请求响应成功：{}",JSON.toJSONString(requestPayResult));
