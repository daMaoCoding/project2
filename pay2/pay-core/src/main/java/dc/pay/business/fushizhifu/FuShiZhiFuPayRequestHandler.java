 ...
 * @date 10 Sep 2019
 */
@RequestPayHandler("FUSHIZHIFU")
public final class FuShiZhiFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(FuShiZhiFuPayRequestHandler.class);
