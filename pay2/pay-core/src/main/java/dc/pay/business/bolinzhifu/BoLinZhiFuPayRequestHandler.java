 ...
 * @date 11 Sep 2019
 */
@RequestPayHandler("BOLINZHIFU")
public final class BoLinZhiFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(BoLinZhiFuPayRequestHandler.class);
