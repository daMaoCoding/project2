...
@Slf4j
@RequestPayHandler("PAIYIYUNZHIFU")
public final class PaiYiYunZhiFuPayRequestHandler extends PayRequestHandler {
    //private static final Logger log = LoggerFactory.getLogger(GeFuPayRequestHandler.class);

     private static final String    	partner = "partner";  //	 商户ID N	Y	商户id
     private static final String    	payment_type = "payment_type";  //	 银行类型 N	Y	1 PC支付宝  2 H5支付宝 3 微信
     private static final String    	total_fee = "total_fee";  //	 金额 N	Y	单位元（人民币）
     private static final String    	out_trade_no = "out_trade_no";  //	 商户订单号 N	Y	商户系统订单号
     private static final String    	notify_url = "notify_url";  //	 下行异步通知地址 N	Y	下行异步通知地址
     private static final String    	return_url = "return_url";  //	 下行同步通知地址 N	Y	下行同步通知地址(在支付完成后接口将会跳转到的该地址)。
     private static final String    	body = "body";  //	 商品说明 N	Y	商品说明
     private static final String    	sign = "sign";  //	 MD5签名 N	N	32位小写MD5签名值，UTF-8编码
    ...
    protected Map<String, String> buildPayParam() throws PayException {
        ...
        log.debug("[派易云支付]-[请求支付]-1.组装请求参数完成：" + JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected String buildPaySign(Map<String,String> params) throws PayException {
        //partner={}&out_trade_no={}&total_fee={}&payment_type={}&notify_url={}&return_url={}&body={}key
        String paramsStr = String.format("partner=%s&out_trade_no=%s&total_fee=%s&payment_type=%s&notify_url=%s&return_url=%s&body=%s%s",
                params.get(partner),
...
*/				
             ...
             log.error("[派易云支付]3.发送支付请求，及获取支付请求结果出错：", e);
             throw new PayException(e.getMessage(), e);
        }
        log.debug("[派易云支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}" ,JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[派易云支付]-[请求支付]-4.处理请求响应成功：" + JSON.toJSONString(requestPayResult));
