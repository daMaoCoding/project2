...
import dc.pay.admin.common.constant.dictmap.factory.DictMapFactory;
...
import dc.pay.admin.core.util.Contrast;
import dc.pay.admin.core.shiro.ShiroKit;
import dc.pay.admin.core.shiro.ShiroUser;
import dc.pay.admin.core.support.HttpKit;
import dc.pay.admin.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(dc.pay.admin.common.annotion.log.BussinessLog)")
