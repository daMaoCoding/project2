package dc.pay.admin.common.node;

import dc.pay.admin.common.constant.Const;
import dc.pay.admin.common.constant.state.IsMenu;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        // PayAdminProperties payAdminProperties = SpringContextHolder.getBean(PayAdminProperties.class);
        return menuNodes;
    }
}
