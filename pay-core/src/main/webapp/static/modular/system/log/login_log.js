...
LoginLog.initColumn = function () {
    return [
        ...
        {title: '用户名称', field: 'account', align: 'center', valign: 'middle'},
        {title: '时间', field: 'createtime', align: 'center',formatter:createtimeFormatter, valign: 'middle', sortable: true},
