...
public class Sha1Util {
     ...
     * SHA1加密
     */
    public static final String SHA1(String decript) {
        try {
    ...
    public static final String SHA256(final String strText) {
        return SHA(strText, "SHA-256");
    }

    public static final String SHA512(final String strText) {
