...
@RequestPayHandler("YINGJIAZHIFU")
public final class YingJiaPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(YingJiaPayRequestHandler.class);
