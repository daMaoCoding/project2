...
public final class SKZhiFuPayResponseHandler extends PayResponseHandler {
    ...
    protected String buildPaySign(Map<String, String> api_response_params, String api_key) throws PayException {
        ...
        String md5Value = HandlerUtil.getMD5UpperCase(requestParamsEncode + channelWrapper.getAPI_MEMBERID() + api_response_params.get(timestamp) + api_response_params.get(nonceStr)).toLowerCase();
