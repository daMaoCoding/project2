 ...
 * Dec 18, 2018
 */
@RequestPayHandler("SHOUMIBA")
public final class ShouMiBaPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(ShouMiBaPayRequestHandler.class);
...
//  timestamp 	时间戳		 String 	是 			当前时间戳。
  ...
  protected Map<String, String> buildPayParam() throws PayException {
      ...
      log.debug("[收米吧支付]-[请求支付]-1.组装请求参数完成：{}" ,JSON.toJSONString(payParam));
      return payParam;
  }
...
//          if (!pay_productname.equals(paramKeys.get(i)) && !pay_attach.equals(paramKeys.get(i)) && StringUtils.isNotBlank(api_response_params.get(paramKeys.get(i)))) {
      ...
      log.debug("[收米吧支付]-[请求支付]-2.生成加密URL签名完成：{}" ,JSON.toJSONString(signMD5));
      return signMD5;
  }
