 ...
 * Jan 16, 2019
 */
@RequestPayHandler("YIWANZHIFU")
public final class YiWanZhiFuPayRequestHandler  extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(YiWanZhiFuPayRequestHandler.class);

//        pay_memberid    商户ID    是     Max(5)    10009
//        pay_orderid     商户订单号    是     Max(50)    提交的订单号必须在自身账户交易中唯一    必须是数字
//        pay_applydate     订单时间    是     Max(20)    格式:2017-12-6 10:15:15
//        pay_bankcode    通道编码    是     Max(10)    请在亿万管理查看编码
...
//        pay_md5sign    签名字符串    是    Max(64)    加密字符串
    ...
    protected Map<String, String> buildPayParam() throws PayException {
        ...
        log.debug("[亿万支付]-[请求支付]-1.组装请求参数完成：{}" ,JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String md5sign) throws PayException {
        ...
        try {
            ...
            log.error("[亿万支付]-[请求支付]-3.1.发送支付请求，及获取支付请求结果出错：", e);
            throw new PayException(null != e.getMessage() ? e.getMessage() : "请求第三方，返回Null",e);
        }
         payResultList.add(result);
         log.debug("[亿万支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}",JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[亿万支付]-[请求支付]-4.处理请求响应成功：{}",JSON.toJSONString(requestPayResult));
