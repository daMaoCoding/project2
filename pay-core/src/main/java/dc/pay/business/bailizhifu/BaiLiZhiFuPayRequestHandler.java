...
@Slf4j
@RequestPayHandler("BAILIZHIFU")
public final class BaiLiZhiFuPayRequestHandler extends PayRequestHandler {
    //private static final Logger log = LoggerFactory.getLogger(GeFuPayRequestHandler.class);
     ...
     private static final String    istype = "istype";   //	支付渠道	int	必填。1：支付宝；
    ...
    protected Map<String, String> buildPayParam() throws PayException {
        ...
        if(1==1){  //HandlerUtil.isWY(channelWrapper)
            ...
            payParam.put(goodsname,HandlerUtil.getYuanWithoutZero(channelWrapper.getAPI_AMOUNT()));
        }

        log.debug("[百利付支付]-[请求支付]-1.组装请求参数完成：" + JSON.toJSONString(payParam));
        return payParam;
    }
...
*/				
				...
				if(StringUtils.isNotBlank(resultStr) && resultStr.contains("<form") && !resultStr.contains("{")){
                    ...
                    if(null!=jsonResultStr && jsonResultStr.containsKey("code") && "1".equalsIgnoreCase(jsonResultStr.getString("code"))
                            ...
                            && jsonResultStr.getJSONObject("data").containsKey("pay_url")&&  StringUtils.isNotBlank( jsonResultStr.getJSONObject("data").getString("pay_url")   )){
             ...
             log.error("[百利付支付]3.发送支付请求，及获取支付请求结果出错：", e);
             throw new PayException(e.getMessage(), e);
        }
        log.debug("[百利付支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}" ,JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[百利付支付]-[请求支付]-4.处理请求响应成功：" + JSON.toJSONString(requestPayResult));
