...
@ResponsePayHandler("HADESPAY")
public final class HadesPayResponseHandler extends PayResponseHandler {
...
//
    ...
    private static final String serialVersionUID = "serialVersionUID";// "1",
    private static final String logger = "logger";// "Logger[com.payinxl.channel.OrderRechargeNotify]",
    private static final String orderno = "orderno";// "B1807071413240677QD",
    private static final String usercode = "usercode";// "U1807061719120285IJ",
    private static final String customno = "customno";// "20180707141324",
    private static final String type = "type";// "2",
    private static final String bankcode = "bankcode";// "ap",
    private static final String tjmoney = "tjmoney";// "30.00",
    private static final String money = "money";// "28.95",
    private static final String status = "status";// "1",
    private static final String refundstatus = "refundstatus";// "-1",
    private static final String currency = "currency";// "1",
    private static final String sign = "sign";// "3ab64439be41d4075f3dc193611e3e85"
    ...
    public String processForOrderId(Map<String, String> API_RESPONSE_PARAMS) throws PayException {
        ...
        log.debug("[HadesPay支付]-[响应支付]-1.获取支付通道响应信息中的订单号完成：" + ordernumberR);
        return ordernumberR;
    }
    ...
    protected String buildPaySign(Map<String, String> params, String api_key) throws PayException {
        //  usercode+“|”+orderno+“|”+customno+“|”+type+“|”+bankcode+“|”+tjmoney+“|”+money+“|”+status+“|”+refundstatus+“|”+currency+“|”+md5key；
    ...
    protected boolean checkPayStatusAndMount(Map<String, String> api_response_params, String amountDb) throws PayException {
        ...
        if (checkAmount && payStatus.equalsIgnoreCase("1")) {
            ...
            log.error("[HadesPay支付]-[响应支付]金额及状态验证错误,订单号：" + channelWrapper.getAPI_ORDER_ID() + ",第三方支付状态：" + payStatus + " ,支付金额：" + responseAmount + " ，应支付金额：" + amountDb);
        }
        log.debug("[HadesPay支付]-[响应支付]-3.验证第三方支付响应支付状态&验证第三方支付金额与数据库订单支付金额完成,验证结果：" + result + " ,金额验证：" + checkAmount + " ,responseAmount=" + responseAmount + " ,数据库金额：" + amountDb + ",第三方响应支付成功标志:" + payStatus + " ,计划成功：1");
        return result;
    }
    ...
    protected boolean checkSignMd5(Map<String, String> api_response_params, String signMd5) {
        ...
        log.debug("[HadesPay支付]-[响应支付]-4.验证MD5签名：" + result);
        return result;
    }

    @Override
    protected String responseSuccess() {
        log.debug("[HadesPay支付]-[响应支付]-5.第三方支付确认收到消息返回内容：" + RESPONSE_PAY_MSG);
