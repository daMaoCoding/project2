...
@RequestPayHandler("XUNJIETONG")
public final class XunJieTongPayRequestHandler extends PayRequestHandler {
    private static final Logger log =  LoggerFactory.getLogger(XunJieTongPayRequestHandler.class);
    ...
    protected Map<String, String> buildPayParam() throws PayException {
            ...
            log.debug("[迅捷通]-[请求支付]-1.组装请求参数完成：{}",JSON.toJSONString(payParam));
            return payParam;
    }
    ...
    protected List<Map<String,String>> sendRequestGetResult(Map<String, String> payParam,String pay_md5sign) throws PayException {
        ...
        try {
            ...
            if("00".equalsIgnoreCase(respCode) && StringUtils.isNotBlank(barCode)){
                ...
                }else if(channel_bank.endsWith("WX_SM")  || channel_bank.endsWith("ZFB_SM") ||channel_bank.endsWith("BD_QB")  || channel_bank.endsWith("QQ_SM") || channel_bank.endsWith("JD_QB")){
                    HashMap<String, String> result = Maps.newHashMap();
            ...
            log.error("[迅捷通]3.发送支付请求，及获取支付请求结果出错：{}",e);
            throw new PayException(e.getMessage(),e);
        }
        log.debug("[迅捷通]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}", JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String,String>> resultListMap) throws PayException {
        ...
        log.debug("[迅捷通]-[请求支付]-4.处理请求响应成功：{}", JSON.toJSONString(requestPayResult));
