package dc.pay.business.dijiazhifu;
 ...
 * Dec 14, 2018
 */
@ResponsePayHandler("DIJIAZHIFU")
public final class DiJiaZhiFuPayResponseHandler extends PayResponseHandler {
  ...
  public String processForOrderId(Map<String, String> API_RESPONSE_PARAMS) throws PayException {
      ...
      log.debug("[迪迦支付]-[响应支付]-1.获取支付通道响应信息中的订单号完成：" + ordernumberR);
      return ordernumberR;
  }
  ...
  protected String buildPaySign(Map<String, String> params, String api_key) throws PayException {
      ...
      try {
    	   decrypt = RSAUtils.decryptByPrivateKey(API_RESPONSE_PARAMS.get(context), channelWrapper.getAPI_KEY()); //channelWrapper ==null,第三方回调数据全部加密，无订单号查找私钥解密
           isVerify = RSAUtils.verify(decrypt, channelWrapper.getAPI_PUBLIC_KEY());
      } catch (Exception e) {
          throw new PayException(SERVER_MSG.RESPONSE_PAY_RESULT_ERROR_APIKEY);
      }
      return String.valueOf(isVerify);
  }
  ...
  protected boolean checkPayStatusAndMount(Map<String, String> api_response_params, String amountDb) throws PayException {
      ...
      String decrypt = null;
      try {  decrypt = RSAUtils.decryptByPrivateKey(api_response_params.get(context), channelWrapper.getAPI_KEY()); } catch (Exception e) {  throw new PayException(SERVER_MSG.RESPONSE_PAY_RESULT_ERROR_APIKEY);    }
      ...
      log.debug("[迪迦支付]-[响应支付]-3.验证第三方支付响应支付状态&验证第三方支付金额与数据库订单支付金额完成,验证结果：" + checkResult + " ,金额验证：" + checkAmount + " ,responseAmount=" + responseAmount + " ,数据库金额：" + amountDb + " ,计划成功：1");
      return checkResult;
  }
  ...
  protected boolean checkSignMd5(Map<String, String> api_response_params, String signMd5) {
      ...
      log.debug("[迪迦支付]-[响应支付]-4.验证MD5签名：" + result);
      return result;
  }

  @Override
  protected String responseSuccess() {
      log.debug("[迪迦支付]-[响应支付]-5.第三方支付确认收到消息返回内容：" + RESPONSE_PAY_MSG);
