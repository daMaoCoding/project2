 ...
 * 05 21, 2019
 */
@RequestPayHandler("DIJIAZHIFU")
public final class DiJiaZhiFuPayRequestHandler extends PayRequestHandler {
  private static final Logger log = LoggerFactory.getLogger(DiJiaZhiFuPayRequestHandler.class);
  ...
  protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String pay_md5sign) throws PayException {
       ...
       try {
        	...
        	log.error("[迪迦支付]-[请求支付]-3.4.发送支付请求，及获取支付请求结果：" + JSON.toJSONString(resJson.toString()) + "订单号：" + channelWrapper.getAPI_ORDER_ID() + " ,通道：" + channelWrapper.getAPI_CHANNEL_BANK_NAME_FlAG());
            throw new PayException(JSON.toJSONString(resJson.toString()));
		}
       }
