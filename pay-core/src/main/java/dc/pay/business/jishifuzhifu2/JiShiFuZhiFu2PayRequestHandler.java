package dc.pay.business.jishifuzhifu2;
 ...
 * Jan 26, 2019
 */
@RequestPayHandler("JISHIFUZHIFU2")
public final class JiShiFuZhiFu2PayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(JiShiFuZhiFu2PayRequestHandler.class);
...
//                    put(paytype, channelWrapper.getAPI_MEMBERID().split("&")[1]);
    ...
    protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String pay_md5sign) throws PayException {
        ...
        try {
                ...
                //只取正确的值，其他情况抛出异常 "respCode":"00"
                if (null != resJson  && resJson.containsKey("respCode") && StringUtils.isNotBlank(resJson.getString("respCode"))
		                && "00".equalsIgnoreCase(resJson.getString("respCode"))
		                &&resJson.containsKey("url") && StringUtils.isNotBlank(resJson.getString("url"))) {
