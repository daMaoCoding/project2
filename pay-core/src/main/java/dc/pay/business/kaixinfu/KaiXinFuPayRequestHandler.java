package dc.pay.business.kaixinfu;
 ...
 * Feb 15, 2019
 */
@RequestPayHandler("KAIXINFU")
public final class KaiXinFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(KaiXinFuPayRequestHandler.class);

    //字段名 变量名 必填  类型  示例值 描述
    //商户ID    pid 是   Int 1001    
    private static final String pid                ="pid";
    //支付网关    gateway 否   String  solidcode   不填写使用系统默认的。official:官方支付接口,epay:易支付,codepay:码支付,payhelper:收款助手,tcp:TCP接口,solidcode:固码支付,bankcard：支付宝转银行卡
//    private static final String gateway                ="gateway";
    //支付方式    type    是   String  alipay  alipay:支付宝,tenpay:财付通,qqpay:QQ钱包,wxpay:微信支付,union:云闪付
    private static final String type                ="type";
    //商户订单号   out_trade_no    是   String  20160806151343349   
    private static final String out_trade_no                ="out_trade_no";
    //异步通知地址  notify_url  是   String  http://kx.fffpay.cc/notify_url.php  服务器异步通知地址
    private static final String notify_url                ="notify_url";
    //跳转通知地址  return_url  是   String  http://kx.fffpay.cc/return_url.php  页面跳转通知地址
...
//                put(gateway,"solidcode");
        ...
        log.debug("[开心付]-[请求支付]-1.组装请求参数完成：{}" ,JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected String buildPaySign(Map<String,String> api_response_params) throws PayException {
        ...
        log.debug("[开心付]-[请求支付]-2.生成加密URL签名完成：{}" ,JSON.toJSONString(signMd5));
        return signMd5;
    }
...
//            } catch (Exception e) {
//                e.printStackTrace();
//                log.error("[开心付]-[请求支付]-3.1.发送支付请求，及获取支付请求结果：" + JSON.toJSONString(resultStr) + "订单号：" + channelWrapper.getAPI_ORDER_ID() + " ,通道：" + channelWrapper.getAPI_CHANNEL_BANK_NAME_FlAG());
//                throw new PayException(resultStr);
//            }
//            //只取正确的值，其他情况抛出异常
...
//        }
        ...
        log.debug("[开心付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}",JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[开心付]-[请求支付]-4.处理请求响应成功：{}",JSON.toJSONString(requestPayResult));
