...
@Slf4j
@RequestPayHandler("YILAIZHIFU2")
public final class YiLaiZhiFu2PayRequestHandler extends PayRequestHandler {
...
*/				
				...
				if(StringUtils.isNotBlank(resultStr) && resultStr.contains("<form") && !resultStr.contains("{")){
                    ...
                    if(null!=jsonResultStr && jsonResultStr.containsKey("code") && "0000".equalsIgnoreCase(jsonResultStr.getString("code"))
                        ...
                        payResultList.add(result);
                    }else if(null!=jsonResultStr && jsonResultStr.containsKey("code") && "0000".equalsIgnoreCase(jsonResultStr.getString("code"))
                            && jsonResultStr.containsKey("redirect_url") && StringUtils.isNotBlank(jsonResultStr.getString("redirect_url"))){
                    	if(HandlerUtil.isWapOrApp(channelWrapper)){
                    		result.put(JUMPURL, jsonResultStr.getString("redirect_url"));
                    	}else{
                    		result.put(QRCONTEXT, jsonResultStr.getString("redirect_url"));
                    	}
                    	payResultList.add(result);
                    }else{
