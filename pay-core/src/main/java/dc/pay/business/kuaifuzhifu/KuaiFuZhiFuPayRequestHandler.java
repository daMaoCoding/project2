 ...
 * Jan 25, 2019
 */
@RequestPayHandler("KUAIFUZHIFU")
public final class KuaiFuZhiFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(KuaiFuZhiFuPayRequestHandler.class);

    private static final String      merchant_no        = "merchant_no";        // 商户号
    private static final String      merchant_order_no  = "merchant_order_no";  // 商户订单号
    private static final String      pay_type           = "pay_type";           // 支付类别
    private static final String      notify_url         = "notify_url";         // 商户通知地址
    private static final String      return_url         = "return_url";         // 支付完跳转地址
    private static final String      trade_amount       = "trade_amount";       // 交易金额 单位为元，精确到小数点后两位，大于等于1元
    ...
    protected Map<String, String> buildPayParam() throws PayException {
        ...
        log.debug("[快付支付]-[请求支付]-1.组装请求参数完成：" + JSON.toJSONString(payParam));
        return payParam;
    }
    ...
    protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String pay_md5sign) throws PayException {
        ...
        try {
        	...
        	log.error("[快付支付]3.发送支付请求，及获取支付请求结果出错：", e);
        	throw new PayException(e.getMessage(), e);
        }
        log.debug("[快付支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}" ,JSON.toJSONString(payResultList));
    ...
    protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
        ...
        log.debug("[快付支付]-[请求支付]-4.处理请求响应成功：" + JSON.toJSONString(requestPayResult));
