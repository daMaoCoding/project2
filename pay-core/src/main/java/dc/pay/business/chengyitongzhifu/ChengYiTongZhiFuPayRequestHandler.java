 ...
 * @author sunny
 */
@RequestPayHandler("CHENGYITONGZHIFU")
public final class ChengYiTongZhiFuPayRequestHandler extends PayRequestHandler {
    private static final Logger log = LoggerFactory.getLogger(ChengYiTongZhiFuPayRequestHandler.class);
...
//    商户系统用户唯一标识	p13_memberid	String(5-32)	是		123456	传会员ID或代表会员ID唯一的信息（如：加密后的会员ID，混淆的会员ID)
  ...
  protected Map<String, String> buildPayParam() throws PayException {
      ...
      log.debug("[诚易通支付]-[请求支付]-1.组装请求参数完成：{}" ,JSON.toJSONString(payParam));
      return payParam;
  }
   ...
   protected String buildPaySign(Map<String,String> api_response_params) throws PayException {
      ...
      log.debug("[诚易通支付]-[请求支付]-2.生成加密URL签名完成：{}" ,JSON.toJSONString(signMD5));
      return signMD5;
  }
  ...
  protected List<Map<String, String>> sendRequestGetResult(Map<String, String> payParam, String pay_md5sign) throws PayException {
      ...
      log.debug("[诚易通支付]-[请求支付]-3.发送支付请求，及获取支付请求结果成功：{}",JSON.toJSONString(payResultList));
  ...
  protected RequestPayResult buildResult(List<Map<String, String>> resultListMap) throws PayException {
      ...
      log.debug("[诚易通支付]-[请求支付]-4.处理请求响应成功：{}",JSON.toJSONString(requestPayResult));
