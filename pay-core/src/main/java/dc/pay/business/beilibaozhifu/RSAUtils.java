...
import dc.pay.business.kuaitongbaozhifu.Base64;
...
public class RSAUtils {
    ...
    public static String sign(byte[] data, String privateKey) throws Exception {
        byte[] keyBytes = dc.pay.business.kuaitongbaozhifu.Base64.decode(privateKey);
        ...
        return dc.pay.business.kuaitongbaozhifu.Base64.encode(signature.sign());
    }
    ...
    public static boolean verify(byte[] data, String publicKey, String sign)
            throws Exception {
        byte[] keyBytes = dc.pay.business.kuaitongbaozhifu.Base64.decode(publicKey);
        ...
        signature.update(data);
        return signature.verify(dc.pay.business.kuaitongbaozhifu.Base64.decode(sign));
    }
    ...
    public static String decryptByPrivateKey(String encryptedData, String privateKey) throws Exception {
        privateKey = privateKey.replaceAll("\n", "");
        return new String(decryptByPrivateKey(dc.pay.business.kuaitongbaozhifu.Base64.decode(encryptedData), privateKey), CHARSET_NAME);
    }
    ...
    public static String encryptByPublicKey(String data, String publicKey) throws Exception {
        publicKey = publicKey.replaceAll("\n", "");
        return dc.pay.business.kuaitongbaozhifu.Base64.encode(encryptByPublicKey(data.getBytes(CHARSET_NAME), publicKey));
    }
