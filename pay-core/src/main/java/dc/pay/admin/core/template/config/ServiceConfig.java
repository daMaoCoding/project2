package dc.pay.admin.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("dc.pay.admin.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.packageName = "dc.pay.admin.modular." + contextConfig.getModuleName() + ".service";
    }
